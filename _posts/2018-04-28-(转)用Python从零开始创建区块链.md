...
![](https://learnblockchain.cn/images/postman_get_mine.png)



*通过post请求，添加一个新交易*

![](https://learnblockchain.cn/images/postman_post_new.png)
...
![](https://learnblockchain.cn/images/postman_register.png)

然后在节点2上挖两个块，确保是更长的链，然后在节点1上访问接口/nodes/resolve ,这时节点1的链会通过共识算法被节点2的链取代。
![](https://learnblockchain.cn/images/postman_resolve.png)
