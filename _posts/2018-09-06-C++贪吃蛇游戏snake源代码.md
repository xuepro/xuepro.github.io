---
layout:       post
title:        "C++贪吃蛇游戏snake源代码"
subtitle:     "C++ code for snake game"
date:         2018-09-16 14:39:00
author:       "xuepro"
...
这是即将出版（明年6月份左右）的“C++7入门到实战”书中的一个简单游戏例子，通过这个例子就明白如何用面向对象编程编写控制台字符游戏了！

请购买我编著的这本现代C++教材，里面由很多实战例子。该书针对小白的，不需要由任何编程基础。
